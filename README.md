Analisis Exploratorio y Curación de Datos - Mentorias Diplomatura en Ciencia de Datos 2020
==========================================================================================

### **Fecha de Entrega**: 19 de Julio del 2020
...
https://github.com/diplodatos2020/AnalisisYCuracion_Mentoria
...
Usar el dataset `dataset_inf_telec_ayc.csv` que se encuentra en el repositorio GitHub de [Introducción a la Mentoria](https://github.com/diplodatos2020/Introduccion_Mentoria)
...
2. Bajar el código:
        ...
        $ git clone https://github.com/diplodatos2020/AnalisisYCuracion_Mentoria.git
